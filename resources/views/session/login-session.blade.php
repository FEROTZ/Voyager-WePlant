            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                ...
                <small class="text-muted">
                  <a href="/login/forgot-password" class="text-info text-gradient font-weight-bold">¿Olvidaste tu contraseña?</a>
                </small>
                  <p class="mb-4 text-sm mx-auto">
                    <a href="register" class="text-info text-gradient font-weight-bold">Crear una cuenta</a>
                  </p>
                </div>
              </div>
            </div>
