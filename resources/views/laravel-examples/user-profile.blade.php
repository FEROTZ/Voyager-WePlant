...
<div>
    <div class="container-fluid">
        <div class="page-header min-height-300 border-radius-xl mt-4" style="background-image: url('../assets/img/curved-images/bg.jpg'); background-position-y: 50%;">
            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="{{auth()->user()->image_url}}" alt="..." class="w-100 border-radius-lg shadow-sm">
                        <form action="/user-profile" method="POST" role="form text-left">
                            @csrf
                            <label for="file-image" class="btn btn-sm btn-icon-only bg-gradient-light position-absolute bottom-0 end-0 mb-n2 me-n2">
                                <i class="fa fa-pen top-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar imagen"></i>
                            </label>
                            <input id="file-image" type="file" name="file-image"/>
                    </div>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                    ...
                    {{-- <div class="form-group">
                        ...
                        <label class="btn bg-gradient-info form-control-label" for="inputGroupFile02">Subir imagen</label>
                    </div> --}}
                    <div class="form-group">
                        <label for="about">{{ 'Acerca de mi' }}</label>
                        <div class="@error('user.about')border border-danger rounded-3 @enderror">
                            <textarea class="form-control" id="about" rows="2" placeholder="Say something about yourself" name="about_me">{{ auth()->user()->about_me }}</textarea>
                        </div>
                    </div>
